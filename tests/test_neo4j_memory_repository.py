...
class Neo4jMemoryRepositoryIntegrationTest(
    unittest.TestCase
):
    repository: Neo4jMemoryRepository

    @classmethod
    def setUpClass(cls) -> None:
        try:
            cls.repository = Neo4jMemoryRepository.from_env()
            cls.repository._driver.verify_connectivity()
    ...
    def test_save_state_removes_obsolete_optional_values(
        self,
    ) -> None:
